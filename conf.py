...
BLOG_AUTHOR = "Will DeBerry"  # (translatable)
BLOG_TITLE = "SudoServers"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://sudoservers.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://sudoservers.com/"
BLOG_EMAIL = "willdeberry@gmail.com"
BLOG_DESCRIPTION = "Random thoughts and battles"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://twitter.com/willdeberry', 'My Twitter', 'icon-twitter'),
        ('https://github.com/willdeberry', 'My Github', 'icon-github'),
    ),
}
...
DEPLOY_COMMANDS = {
    'default': [
        "rsync -avz -e 'ssh' --delete output/ will@sudoservers.com:docker/www/sudoservers",
    ]
}
...
# is in the manual.
COMMENT_SYSTEM_ID = "https-sudoservers-com"
